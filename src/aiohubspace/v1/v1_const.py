...
AFERO_CLIENTS: Final[dict[str, dict[str, str]]] = {
    "hubspace": {
        ...
        "OPENID_URL": "https://accounts.hubspaceconnect.com/auth/realms/thd/protocol/openid-connect/auth",
        "CODE_URL": "https://accounts.hubspaceconnect.com/auth/realms/thd/login-actions/authenticate",
        "TOKEN_URL": "https://accounts.hubspaceconnect.com/auth/realms/thd/protocol/openid-connect/token",
    },
    "myko": {
